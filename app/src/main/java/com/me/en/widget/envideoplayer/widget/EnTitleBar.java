...
public class EnTitleBar extends LinearLayout {
    private ImageButton bt_back;
    private TextView tv_title, tv_totalTime;

    public EnTitleBar(Context context) {
        this(context, null);
    }

    public EnTitleBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EnTitleBar(Context context, AttributeSet attrs, int defStyle) {
